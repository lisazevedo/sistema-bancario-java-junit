...
public class SaqueTesteIntegracao {
     ...
     */
    @Test
    void deveEfetuarSaqueBemSucedido() {
        Double valor = 100.00;
     ...
     */
    @Test
    void deveFalharSaqueComSaldoInsuficiente() {
        Double valor = 2100.00;
        assertThrows(IllegalArgumentException.class, () -> cliente.getConta().saque(valor)); 
    }
     ...
     */
    @Test
    void deveFalharSaqueComValorNegativo() {
        Double valor = -10.00;
        assertThrows(IllegalArgumentException.class, () -> cliente.getConta().saque(valor)); 
    }
}
